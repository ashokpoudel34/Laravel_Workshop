  ...
  <body>
    ...
    <header id="header" class="d-flex align-items-center">
      <div class="container d-flex justify-content-between align-items-center">
        ...
        <div class="logo">
          <h1><a href="{{route('admin_site.home') }}">VideoSite - Admin</a></h1>
        </div>

        <nav id="navbar" class="navbar">

        <ul>
            <li><a href="{{ route('admin_site.home') }}">Home</a></li>
            <li><a href="{{ route('admin_site.login') }}">Login</a></li>
            <li><a href="{{ route('admin_site.categories') }}">Categories</a></li>
            <li><a href="{{ route('admin_site.contact') }}">Contact-us</a></li>
    ...
    <footer id="footer">
      <div class="container">
        <div class="copyright">
          &copy; Copyright <strong><span>Video Site - Admin</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
